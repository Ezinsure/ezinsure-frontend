...
export const motorPaths = {
  admin: {
    ...
    prospects: '/admin/motor/prospects',
  ...
  agent: {
    ...
    renewals: '/agent/motor/renewals',
    prospects: '/agent/motor/prospects',
    faq: '/agent/motor/FAQ',
  ...
  superAdmin: {
    ...
    renewals: '/super_admin/motor/renewals',
    prospects: '/super_admin/motor/prospects',
  ...
  finance: {
    ...
    renewals: '/finance/motor/renewals',
    prospects: '/finance/motor/prospects',
