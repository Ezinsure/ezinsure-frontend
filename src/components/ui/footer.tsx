        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Insurance made effortless. Get instant quotes, compare options, and complete purchases in minutes—all online or via mobile.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/track" className="text-gray-300 hover:text-white transition-colors">Track Application</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Motorbike Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Car Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Building Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Travel Insurance</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">SME Bundle Coverage</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-[var(--accent-orange)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">info@ezinsure.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-[var(--accent-orange)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-gray-300">+250 782 123 456</span>
              </li>
            </ul>
          </div>
        </div>
