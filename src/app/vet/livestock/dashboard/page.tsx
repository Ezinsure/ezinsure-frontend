...
export default function VetLivestockDashboardPage() {
  return (
    <div className="p-6 lg:p-8">
      <div className="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white p-8 text-center shadow-sm">
        ...
        <h1 className="text-2xl font-semibold text-gray-900">Vet portal</h1>
        <p className="mt-2 text-sm text-gray-600">
          Assigned animals and proof-of-payment uploads will be available in the next module.
        </p>
      </div>
    </div>
  );
