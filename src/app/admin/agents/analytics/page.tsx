        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 mb-6">
            ...
            <div className="group relative bg-gradient-to-br from-slate-50 to-slate-100/50 rounded-xl shadow-sm border border-slate-200/50 p-5 hover:shadow-md transition-all duration-200 overflow-hidden">
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-[10px] font-medium text-slate-600 uppercase tracking-wider mb-1.5">Total Agents</p>
                  ...
                  <p className="text-[10px] text-slate-500">Active performers</p>
                </div>
            ...
            <div className="group relative bg-gradient-to-br from-slate-50 to-slate-100/50 rounded-xl shadow-sm border border-slate-200/50 p-5 hover:shadow-md transition-all duration-200 overflow-hidden">
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-[10px] font-medium text-slate-600 uppercase tracking-wider mb-1.5">Total Commission</p>
                  <p className="text-lg font-semibold text-gray-900 mb-0.5">
                    {isLoading ? (
                  ...
                  <p className="text-[10px] text-slate-500">Commission earned</p>
                </div>
                <div className="h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center group-hover:bg-slate-200 transition-colors">
            ...
            <div className="group relative bg-gradient-to-br from-slate-50 to-slate-100/50 rounded-xl shadow-sm border border-slate-200/50 p-5 hover:shadow-md transition-all duration-200 overflow-hidden">
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-[10px] font-medium text-slate-600 uppercase tracking-wider mb-1.5">Applications</p>
                  <p className="text-lg font-semibold text-gray-900 mb-0.5">
                    {isLoading ? (
                      <span className="inline-block w-12 h-5 bg-gray-200 rounded animate-pulse"></span>
                    ) : (
            ...
            <div className="group relative bg-gradient-to-br from-slate-50 to-slate-100/50 rounded-xl shadow-sm border border-slate-200/50 p-5 hover:shadow-md transition-all duration-200 overflow-hidden">
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-[10px] font-medium text-slate-600 uppercase tracking-wider mb-1.5">Avg Commission</p>
                  <p className="text-lg font-semibold text-gray-900 mb-0.5">
                    {isLoading ? (
                  ...
                  <p className="text-[10px] text-slate-500">Per agent</p>
                </div>
                <div className="h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center group-hover:bg-slate-200 transition-colors">
            ...
            <div className="group relative bg-gradient-to-br from-slate-50 to-slate-100/50 rounded-xl shadow-sm border border-slate-200/50 p-5 hover:shadow-md transition-all duration-200 overflow-hidden">
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-[10px] font-medium text-slate-600 uppercase tracking-wider mb-1.5">Total Revenue</p>
                  <p className="text-lg font-semibold text-gray-900 mb-0.5">
                    {isLoading ? (
                      <span className="inline-block w-16 h-5 bg-gray-200 rounded animate-pulse"></span>
                    ) : (
          ...
          {!isLoading && filteredAndSortedAgents.length > 0 && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
              ...
              <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-5 hover:shadow-md transition-shadow">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-5 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h3 className="text-xs sm:text-sm font-medium text-gray-700 flex items-center gap-2">
                    <Activity className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-slate-600" />
                    Weekly Trend
                  </h3>
                </div>
                <ResponsiveContainer width="100%" height={300}>
              ...
              <div className="lg:col-span-3 bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-5 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h3 className="text-xs sm:text-sm font-medium text-gray-700 flex items-center gap-2">
                    <PieChartIcon className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-slate-600" />
