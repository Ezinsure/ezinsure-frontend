...
const pageButtonClass =
  'relative inline-flex items-center px-3 py-2 text-sm font-medium ring-1 ring-inset ring-slate-200 transition-colors focus:z-20 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-40';
