...
> = {
  ...
  PENDING_ADMIN_REVIEW: { bg: 'bg-orange-50', text: 'text-orange-800', ring: 'ring-orange-200' },
  COMMISSION_APPROVED: { bg: 'bg-green-50', text: 'text-green-800', ring: 'ring-green-200' },
  READY_TO_BE_PAID: { bg: 'bg-lime-50', text: 'text-lime-900', ring: 'ring-lime-200' },
  PAID: { bg: 'bg-green-100', text: 'text-green-900', ring: 'ring-green-300' },
