        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-8 mb-8">
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="text-xs uppercase tracking-[0.35em] text-slate-400">Livestock workspace</p>
                  <h1 className="text-3xl font-semibold text-slate-900 mt-2">Welcome back, {user?.fullName || 'Veterinarian'}.</h1>
                  <p className="text-slate-500 mt-2">Track assigned animals, payment proofs, and commission in one place.</p>
                </div>
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="rounded-3xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-8 text-white shadow-lg">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold">Payment proofs</h3>
                    <p className="text-sm text-blue-100">Upload proof for each assigned animal.</p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/vet/livestock/applications"
              ...
              <div className="rounded-3xl bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-700 p-8 text-white shadow-lg">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-100">Update your profile and view help articles.</p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-4">
                  <Link
                    href={`${VET_LIVESTOCK_BASE}/FAQ`}
